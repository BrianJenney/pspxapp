...
const SignIn = () => {
    ...
    return (
        <>
            <Helmet>
                <title>PSPX APP</title>
                <meta
                    name="description"
                    content="Deploy CSS changes in real time with no code. Tired of waiting for your dev team's release cycle? Write your own styles and deploy with the click of a button"
                />
            </Helmet>
            <div
                style={{
            ...
            >
                <section className={styles.header}>
                    <div>
                        ...
                        <h2 style={{ fontWeight: '200' }}>
                            Instead of waiting for your development team's
                            release cycle, create the styles you want deployed,
                            preview the generated css and then release!
                        </h2>
                ...
                >
                    ...
                    <div className={styles.features}>
                        ...
                        <h2 style={{ fontWeight: '100' }}>
                            ...
                            - Rollback changes with the click of a button and
                            access old versions of your style configs
                        </h2>
                    </div>
                    <div className={styles.features}>
                        <svg
                        ...
                        <h2 style={{ fontWeight: '100' }}>
                            ...
                            - Check out your changes in a preview environment
                    ...
                    <div className={styles.features}>
                        ...
                        <h2 style={{ fontWeight: '100' }}>
                            ...
                            - Generate formatted CSS with the click of a button
                            to inspect the code
                        </h2>
                    </div>
                </section>
